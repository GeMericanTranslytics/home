  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 bg-card/15 ring-offset-4 ring-offset-background shadow-2xl">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto bg-card/30 ring-offset-4 ring-offset-background shadow-2xl border border-border/30 ring-offset-4 ring-offset-background shadow-2xl px-10 py-10">
          {/* Profile Image */}
