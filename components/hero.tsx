...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 bg-card/30 backdrop-blur-sm mb-8">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <div className="relative mb-8">
            <div className="w-40 h-40 sm:w-48 sm:h-48 rounded-full overflow-hidden ring-4 ring-primary/50 ring-offset-4 ring-offset-background shadow-2xl">
              <Image
