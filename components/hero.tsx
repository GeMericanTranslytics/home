    ...
    <section className="relative min-h-screen flex items-center justify-center pt-16 bg-black/75">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto bg-white/10 border border-white/20 rounded-2xl px-10 py-10">
          ...
          {/* Title */}
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold mb-6" style={{ color: 'Cyan', fontFamily: '"impact", impact, impact' }}>
            {profileData.title}
          </h2>

          {/* Tagline */}
          <p className="text-lg sm:text-xl text-muted-foreground mb-6 max-w-2xl text-balance" style={{ color: 'Cyan', fontFamily: '"Times New Roman", Times, serif', fontStyle: 'impact' }}>
            {profileData.tagline}
          </p>
